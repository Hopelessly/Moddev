...
public class EventHandler {
    ...
    public void onPlayerSleep(PlayerSleepInBedEvent event)
    {
        ...
        String message = String.format("You refreshed yourself in the bed. You received 50 Thirst, you have " + (int) thirst.getThirst()) +" thirst left.";
        player.addChatMessage(new TextComponentString(message));
    }
...
//            thirst.consume(cost);
//
//            String message = String.format("You absorbed fall damage. It costed , you have  left.", (int) cost, (int) thirst.Thirst());
//            player.addChatMessage(new TextComponentString(message));
//
